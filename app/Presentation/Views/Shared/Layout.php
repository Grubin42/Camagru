        ...
        <nav>
            <ul>
                ...
                <?php if (isset($_SESSION['user'])): ?>
                        <li>
                            <a href="/profile" class="d-flex flex-column align-items-center text-decoration-none">
                ...
                <?php if (!isset($_SESSION['user'])): ?>
                    <li>
                        <a href="/register" class="d-flex flex-column align-items-center text-decoration-none">
                    ...
                    <li>
                        <a href="/login" class="d-flex flex-column align-items-center text-decoration-none">
                ...
                <?php if (isset($_SESSION['user'])): ?>
                    <li>
                        <a href="/post" class="d-flex flex-column align-items-center text-decoration-none">
                    ...
                    <li>
                        <a href="/logout" class="d-flex flex-column align-items-center text-decoration-none">
                            <svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-login-2">
                                <path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M9 8v-2a2 2 0 0 1 2 -2h7a2 2 0 0 1 2 2v12a2 2 0 0 1 -2 2h-7a2 2 0 0 1 -2 -2v-2" />
                                <path d="M3 12h13l-3 -3" /><path d="M13 15l3 -3" />
                            </svg>
